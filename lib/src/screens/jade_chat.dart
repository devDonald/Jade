...
import 'package:medcare/src/helpers/constants.dart';

String errorTextHolder = '';

class JadeChat extends StatefulWidget {
  @override
  JadeChatState createState() => JadeChatState();
}

class JadeChatState extends State<JadeChat> {
                ...
                Container(
                    ...
                    decoration: new BoxDecoration(
                        ...
                        image: new DecorationImage(
                            ...
                            image: new AssetImage("images/medcare.png")))),
                Container(
                    margin: EdgeInsets.fromLTRB(0, 15, 0, 0),
                    alignment: Alignment.center,
                    padding: EdgeInsets.all(10),
                    child: Text(
                      'for your security, we need a few details to make your chat unique',
